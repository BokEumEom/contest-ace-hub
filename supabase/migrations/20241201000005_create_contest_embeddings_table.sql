-- Create contest_embeddings table for vector search
-- Migration: 20241201000005_create_contest_embeddings_table.sql

-- Enable pgvector extension
CREATE EXTENSION IF NOT EXISTS vector;

-- Create the contest_embeddings table
...
COMMENT ON COLUMN contest_embeddings.similarity IS 'Similarity score (0-1)';
